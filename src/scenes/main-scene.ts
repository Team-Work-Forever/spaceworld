...
import { AsteroidFactory, AsteroidGroup, Asteroid } from "../gameObjects/asteroids";
...
export default class MainScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('purple_asteroid', '../../assets/asteroid_purple_sprite.png', { frameWidth: 125.9, frameHeight: 59 });
        this.load.spritesheet('yellow_asteroid', '../../assets/yellow_asteroid_sprite.png', { frameWidth: 112, frameHeight: 53 });
    ...
    create() {
        ...
        // UI
        this._info_text = this.add.text(0, 0, 'SLB OLÉÉÉÉ OLÉÉÉÉ OLÉÉÉÉ', { color: '#00ff00' })
    ...
    spawnAsteroids() {
        ...
        switch (objectType) {
            case 1:
                object = this._asteroid_factory.createBlueAsteroid(window.innerWidth + 50, randomY);
                break;
            case 2:
                object = this._asteroid_factory.createYellowAsteroid(window.innerWidth + 50, randomY);
                break;
            case 3:
                object = this._asteroid_factory.createPurpleAsteroid(window.innerWidth + 50, randomY);
                break;
        }
    ...
    update(): void {
        ...
        this._info_text.setText([
            'Lifes:', this._player.lifes.toString(),
            'Used: ', this._player.laser_group.getTotalUsed().toString(),
            'Free: ', this._player.laser_group.getTotalFree().toString(),
            'Used -> Asteroids: ', this._asteroidGroup.getTotalUsed().toString(),
            'Free -> Asteroids: ', this._asteroidGroup.getTotalFree().toString(),
        ])
